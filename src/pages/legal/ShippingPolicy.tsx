    ...
    <div className="min-h-screen bg-gray-50">
      <div className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-white rounded-lg shadow-sm p-8">
          <h1 className="text-3xl font-bold mb-2">Shipping and Delivery Policy</h1>
          ...
          <div className="space-y-6 text-gray-700">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">2. Digital Service Delivery</h2>
              
              <h3 className="text-xl font-semibold mb-3">2.1 Immediate Access</h3>
              ...
              <h3 className="text-xl font-semibold mb-3">2.2 Campaign Creation</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">2.3 Creator Onboarding</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">3. Product Sampling (When Applicable)</h2>
              <p className="mb-4">
                In some campaigns, brands may need to ship physical products to creators for review or promotion:
              </p>

              <h3 className="text-xl font-semibold mb-3">3.1 Brand Responsibility</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">3.2 Delivery Timeframes</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">3.3 Tracking and Confirmation</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">3.4 Shipping Issues</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">4. Data and Analytics Delivery</h2>
              
              <h3 className="text-xl font-semibold mb-3">4.1 Real-Time Analytics</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">4.2 Reports</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">5. Payment Delivery</h2>
              
              <h3 className="text-xl font-semibold mb-3">5.1 For Creators</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">5.2 For Brands</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">6. Content Delivery</h2>
              
              <h3 className="text-xl font-semibold mb-3">6.1 Content Submission</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">6.2 Content Publication</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">6.3 Content Rights</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <h3 className="text-xl font-semibold mb-3">7.1 Platform Uptime</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="text-xl font-semibold mb-3">7.2 Support Delivery</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">9. Delays and Issues</h2>
              
              <h3 className="text-xl font-semibold mb-3">9.1 Digital Service Delays</h3>
              ...
              <h3 className="text-xl font-semibold mb-3">9.2 Physical Shipping Delays</h3>
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">10. International Considerations</h2>
              <p className="mb-4">
            ...
            <section>
              <h2 className="text-2xl font-semibold mb-4">11. Contact for Delivery Issues</h2>
              <p className="mb-4">
