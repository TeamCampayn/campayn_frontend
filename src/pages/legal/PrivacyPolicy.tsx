        ...
        <div className="grain rounded-[2rem] bg-panel p-8 md:p-12 border border-foreground/10 shadow-sm">
          ...
          <div className="space-y-8 font-sans text-zinc-600 leading-relaxed text-sm md:text-base">
            ...
            <section>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">2.1 Personal Information</h3>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">2.2 Instagram Data</h3>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">2.3 Usage Information</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">2.4 Technical Information</h3>
            ...
            <section>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">3.1 To Provide Services</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">3.2 To Improve Our Platform</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">3.3 For Communication</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">3.4 For Security and Compliance</h3>
              <ul className="list-disc pl-6 space-y-2">
            ...
            <section>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">4.1 With Other Users</h3>
              <ul className="list-disc pl-6 space-y-2 mb-4">
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">4.2 With Service Providers</h3>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">4.3 For Legal Reasons</h3>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">4.4 Business Transfers</h3>
              <p className="mb-4">
            ...
            <section>
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">6.1 Access and Update</h3>
              <p className="mb-4">
                You can access and update your personal information through your account settings.
              </p>

              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">6.2 Data Portability</h3>
              <p className="mb-4">
                You can request a copy of your personal data in a machine-readable format.
              </p>

              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">6.3 Account Deletion</h3>
              <p className="mb-4">
              ...
              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">6.4 Marketing Communications</h3>
              <p className="mb-4">
                You can opt out of marketing emails by clicking "unsubscribe" in any email or updating your preferences.
              </p>

              <h3 className="font-heading text-lg font-bold text-zinc-900 mb-2 mt-4">6.5 Cookie Management</h3>
              <p className="mb-4">
