        ...
        <div className="max-w-7xl mx-auto px-6 py-16">
          <div className="grid lg:grid-cols-6 gap-12">
            ...
            <div className="lg:col-span-4 grid md:grid-cols-4 gap-8">
              <div>
                <h4 className="text-lg font-semibold mb-4 text-blue-600">Company</h4>
              ...
              <div>
                <h4 className="text-lg font-semibold mb-4 text-purple-600">Services</h4>
                <ul className="space-y-3">
          ...
          <div className="mt-16 pt-8 border-t border-slate-200">
            <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between space-y-6 lg:space-y-0">
              <div>
                <h4 className="text-xl font-semibold mb-2 text-slate-800">Stay Updated</h4>
                <p className="text-slate-600">Get the latest news, insights, and creator trends delivered to your inbox.</p>
              </div>
              <div className="flex flex-col sm:flex-row gap-4 lg:max-w-md lg:w-full">
                <input
                  type="email"
                  placeholder="Enter your email"
                  className="flex-1 px-4 py-3 bg-white/70 border border-slate-200 rounded-lg text-slate-800 placeholder-slate-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm"
                />
                <button className="px-6 py-3 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white rounded-lg font-semibold transition-all duration-200 transform hover:scale-105 whitespace-nowrap shadow-lg hover:shadow-xl">
                  Subscribe
                </button>
              </div>
            </div>
