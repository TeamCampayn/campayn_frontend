      ...
      <div className="lg:hidden w-full max-w-xs space-y-2 overflow-hidden">
        ...
        <div className="bg-white rounded-lg shadow-lg p-2 border border-gray-200">
          <div className="text-center p-2 bg-gradient-to-r from-emerald-50 to-cyan-50 rounded-lg border border-emerald-200">
            <div className="flex items-center justify-center space-x-1 mb-1">
              <Heart className="w-3 h-3 text-emerald-600 animate-pulse" />
              <div className="text-xs font-bold text-gray-800 truncate">Creator Economy</div>
            </div>
            <div className="text-xs text-emerald-700 truncate">Bridging Digital Divide</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-2 border border-gray-200 space-y-2">
          ...
          <div className="bg-gray-50 rounded-lg p-2 border border-gray-200">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-semibold text-gray-700 truncate">Traditional</span>
              <span className="text-xs bg-gray-300 text-gray-700 px-1.5 py-0.5 rounded-full font-bold">5%</span>
            </div>
            <div className="w-full bg-gray-200 rounded-full h-1.5 mb-1 overflow-hidden">
              <div 
                className={`bg-gradient-to-r from-gray-400 to-gray-600 h-1.5 rounded-full transition-all duration-1000 ${
                  animateProgress ? 'w-[5%]' : 'w-0'
                }`}
              ></div>
            </div>
            <div className="text-xs text-gray-600 truncate">Metro cities only</div>
          </div>
          
          {/* Campayn's Reach */}
          <div className="bg-gradient-to-br from-emerald-50 to-cyan-50 rounded-lg p-2 border-2 border-emerald-200 shadow-lg">
            <div className="flex items-center justify-between mb-1">
              <span className="text-xs font-bold text-emerald-800 flex items-center space-x-1 truncate">
                <Zap className="w-2.5 h-2.5" />
                <span>Campayn</span>
              </span>
              <span className="text-xs bg-emerald-300 text-emerald-800 px-1.5 py-0.5 rounded-full font-bold animate-pulse">95%</span>
            </div>
            <div className="w-full bg-emerald-200 rounded-full h-1.5 mb-1 overflow-hidden">
              <div 
                className={`bg-gradient-to-r from-emerald-500 to-cyan-600 h-1.5 rounded-full transition-all duration-1500 delay-300 shadow-inner ${
                  animateProgress ? 'w-[95%]' : 'w-0'
                }`}
              ></div>
            </div>
            <div className="text-xs text-emerald-700 font-semibold truncate">Bharat included</div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow-lg p-2 border border-gray-200">
          <div className="grid grid-cols-2 gap-2">
            <div className="bg-gradient-to-r from-orange-50 to-red-50 rounded-lg p-2 text-center border border-orange-200">
            ...
            <div className="bg-gradient-to-r from-purple-50 to-indigo-50 rounded-lg p-2 text-center border border-purple-200">
